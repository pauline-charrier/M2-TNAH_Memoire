...
##### Documents auxiliaires (dédiés à la recherche)
...
``` 
##### Développement d'un outil d'interface utilisateur 
...
##### Tâche de post-correction de corpus textuel bruité assistée par intelligence artificielle (API GPT 3.5)
